 ...
 * 自定义游戏模式对话框
 */
public class SelfDefinedGameModeDialog extends JDialog implements
	...
	public SelfDefinedGameModeDialog(JFrame jf, int rowCount, int columnCount,
			int mineCount) {
		super(jf, "自定义雷区");
	 ...
	 */
	public static int showSelfDefinedGameModeDialog(JFrame jf, int rowCount,
			int columnCount, int mineCount) {
		SelfDefinedGameModeDialog dialog = new SelfDefinedGameModeDialog(jf,
	...
	private boolean isInputCorrect() {
		...
		if (mineCount < 10 || mineCount > columnCount * rowCount * 4 / 5) {
			hintLabel.setText("雷数只能在10和" + columnCount * rowCount * 4 / 5
					+ "之间");
			return false;
		}
		return true;
