...
<body>
	...
	<div id="formwrapper">
		...
		<form action="system/company.action" method="post">
			<input type="hidden" name="method:save"> <input type="hidden"
				name="id" value="<s:property value="id"/>">
			<fieldset>
				<legend>公司基本信息设置（在进行组织机构设置之前，请先设置公司的基本信息） </legend>
				<div>
				...
				<div>
					<label for="fax">传真</label> <input type="text" name="fax" id="fax"
						value="${fax }" size="30" /> <br />
				</div>
				<div>
					<label for="address">地址</label> <input type="text" name="address"
						id="address" value="${address }" size="60" /> <br />
				</div>
				<div>
					<label for="postcode">邮编</label> <input type="text" name="postcode"
						id="postcode" value="${postcode }" size="20" /> <br />
				</div>
				<div>
					<label for="site">网站</label> <input type="text" name="site"
						id="site" value="${site }" size="30" /> <br />
				</div>
				<div>
					<label for="email">电子邮件</label> <input type="text" name="email"
						id="email" value="${email }" size="30" /> <br />
				</div>
				<div>
					<label for="industry">所属行业</label> <input type="text"
						name="industry" id="industry" value="${industry }" size="30" />
					<br />
				</div>
				<div>
