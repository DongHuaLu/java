...
<script type="text/javascript">
				...
				.dataTable(
						{
							...
							"oLanguage" : { // 主要用于设置各种提示文本
								...
								"sLengthMenu" : "每页_MENU_行<input type='button' value='添加角色' onclick='addRole()'/> <input type='button' value='删除角色' onclick='deleteRole()'/>  <input type='button' value='更新角色' onclick='updateRole()'/>",// 显示每页多少条记录
	...
	function deleteRole() {
		...
		var id = anSelected[0].children[0].innerHTML;
		$.get("system/role!del.action?id=" + id, function() {
	...
	function updateRole() {
		...
		window.location = "system/role!updateInput.action?id=" + id;
	}
	//获得选中行集合的方法
